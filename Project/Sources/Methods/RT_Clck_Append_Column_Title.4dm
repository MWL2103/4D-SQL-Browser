...
/* Method: RT_Clck_Append_Column_Title
      
  Purpose: Handles right-click requests to append column title to clipboard
...
If ($MenuText_t="")  // Execute menu item
	...
	$Temp_t:=Get text from pasteboard
	$Temp_t:=$Temp_t+", "+OBJECT Get title($Object_p->)
